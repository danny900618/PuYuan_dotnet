...
namespace PuYuan.Controllers
{
    ...
    public class RegisterController : ControllerBase
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult> PostUser(UserViewModel userRegister, DateTime dateTime)
        {
        ...
        /// <returns></returns>
        [HttpGet("check")]
        public async Task<ActionResult> GetUser([FromQuery] string account)
        {
